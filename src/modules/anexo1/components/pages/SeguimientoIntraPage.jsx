...
import SeguimientoIntraForm from '../forms/SeguimientoIntraForm';
import SeguimientoIntraTable from '../tables/SeguimientoIntraTable';
    ...
    return (
      <div className="min-h-screen bg-white">
        <div className="bg-white shadow-2xl rounded-2xl p-4 border border-gray-100">
          <div className="flex items-center justify-between mb-8">
            <div>
              <h1 className="text-4xl font-bold bg-black bg-clip-text text-transparent mb-2">
                <FontAwesomeIcon icon={faHospitalUser} className="w-8 h-8 text-black pr-2" />
                {modo === 'editar' ? 'Editar Seguimiento' : 'Nuevo Seguimiento Intrahospitalario'}
              </h1>
            </div>
          ...
          <SeguimientoIntraForm item={selectedItem} onSaved={handleSaved} />
        </div>
      </div>
    );
  }
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between mb-2">
          <div className="flex items-center">
            <h1 className="text-4xl font-bold bg-black bg-clip-text text-transparent m-2">
              <FontAwesomeIcon icon={faHospitalUser} className="w-8 h-8 text-black pr-2" />Seguimiento Intrahospitalario
            </h1>
          </div>
