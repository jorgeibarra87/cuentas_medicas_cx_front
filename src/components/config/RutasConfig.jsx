...
import { getAuditoriaCuentasMedicasRoutes } from '../../modules/auditoria_cuentas_medicas';
    ...
    return (
        <HashRouter>
            <Routes>
                ...
                <Route path='/auditoria'> {getAuditoriaCuentasMedicasRoutes(isLogged, loading)} </Route>
