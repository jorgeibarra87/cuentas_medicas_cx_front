  ...
  const toggleSubmenu = (nombre) => {
    ...
    const opcionesMenu = [
        ...
        },
        {
            ...
            roles: ['ROLE_ADMINISTRADOR', 'ROLE_AUDITORIA_CIRUGIAS_ADMIN'],
            submenu: [
                { nombre: 'Procedimientos', ruta: '/auditoria/procedimientos', roles: ['ROLE_ADMINISTRADOR', 'ROLE_AUDITORIA_CIRUGIAS_ADMIN'] }
            ]
        }
